...
class INTP_Model(nn.Module):
    ...
    def __init__(self, settings, device):
        ...
        self.gat = GAT(in_channels=num_features_in, hidden_channels=conv_dim, num_layers=2, out_channels=1).to(self.device)
    ...
    def forward(self, batch):
        ...
        output = self.gat(x_l, edge_index, edge_weight)
