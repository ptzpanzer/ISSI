...
sweep_config = {
    ...
    'parameters':{
        "model": {
            'values': ["FEGSAGE_CA_GBD_END_REFINED", ]
        },
        "seed": {
            'values': [1, 2, 3, 4, 5]
        },
        ...
        "dataset": {
            'values': [
                "OceanAt_res250_reg4c", "SAQN_res250_reg4c", 
            ]
        },
        "fold": {
            'values': [4, ]
...
m_GPU_models = ["GAT", "FEGSAGE_CA", "FEGSAGE_CNA", "FEGSAGE_CRA", "FEGSAGE_CCA", "NODEFORMER", ]
s_GPU_models = ["LSPE", ]
dev_GPU_models = []
